...
/**
 * Created by fgroch on 04.02.17.
 */
@Integration
@Rollback
class FlowableTaskServiceIntegrationSpec extends Specification {
    ...
    def "when service is created runtime, task and repostitory services are created"() {
        expect:
